...
const en = {
  ...
  auth: {
    ...
    guestCta: "Sign in",
    seePrice: "Sign in to see price",
    lockedTitle: "Sign in to view details & price",
    lockedBody: "Browsing is free. Sign in to see pricing, full specs, and to book or reserve.",
    ...
    requestManualOtp: "Didn't get a code? Request one now",
    requestingManualOtp: "Requesting…",
    manualOtpRequested:
      "An agent has been alerted. Your code will appear here shortly — keep this screen open.",
    manualOtpArrivedTitle: "Your TrendyWheels code",
    manualOtpArrivedBody: "Your verification code is ready — tap to continue.",
    manualOtpExhausted: "This number already used its one-time code. Please contact support.",
    manualOtpFailed: "Couldn't request a code. Please try again.",
    ...
    forgotSubtitle: "Enter your phone number and we'll send a code to reset your password.",
