      ...
      <div style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.heroTitle}>
            Help comes<br />first<span style={{ color: colors.brand.trendyPink }}>.</span>
          </h1>
          <p style={styles.heroSub}>
            Every ticket, every customer, every conversation — handled with care.
          </p>
          <div style={styles.heroFooter}>
            <span style={styles.heroFooterDot} />
            <span>Customer success · TrendyWheels</span>
          </div>
        </div>
      </div>
      ...
      <div style={styles.formPanel}>
        <div style={styles.formInner}>
          <div style={{ marginBottom: 28 }}>
            <span style={styles.eyebrow}>SUPPORT AGENT ACCESS</span>
            <h2 style={styles.formTitle}>Sign in</h2>
            <p style={styles.formSub}>Welcome back. Your queue is waiting.</p>
          </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  submit: {
    ...
    background: colors.brand.friendlyBlue, color: "#fff",
