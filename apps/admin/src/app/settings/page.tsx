  ...
  return (
    <>
      <PageHeader
        ...
        subtitle={cfg ? `Last updated ${new Date(cfg.updatedAt).toLocaleString()}` : undefined}
        helpButton={<TourHelpButton pageKey="admin:settings" />}
      />
      <div className="p-8">
        ...
        {tab === "payment" && (
          <div className="max-w-xl bg-white rounded-xl border p-6 space-y-4">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-sm text-yellow-700">
              <strong>Payment Gateway:</strong> Cash-on-pickup is active for v1. Paymob integration
              is planned for v1.1 post-launch.
            </div>
            <SaveButton
              onClick={savePayment}
              isPending={saveMutation.isPending}
        ...
        {tab === "api" && (
          <div className="max-w-xl bg-white rounded-xl border p-6 space-y-4">
            ...
            <p className="text-xs text-gray-500">
              ...
              database. Rotation requires SSH access for security. Surface here is informational
              only.
            </p>
            {[
