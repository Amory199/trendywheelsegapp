// Staff repairs queue. Part of the unified staff hub (see app/crm/_layout).
// Any staff member can triage repair work orders: see what's been requested,
// scheduled, in progress, or completed, and open one to start/complete it.
// Mirrors the admin repairs list but navigates inside the staff hub so the
// bottom bar stays on staff tabs (no admin-console exposure).
  ...
  return (
    <View style={styles.root}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, display(0.3)]}>{t("crm.repairs.title")}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  kicker: { color: "#F5B800", fontSize: 11, fontWeight: "800" },
  title: {
