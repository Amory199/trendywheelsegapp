    ...
    <>
      ...
      <View style={styles.root}>
        <View style={styles.iconWrap}>
          <Ionicons name="color-palette" size={48} color={colors.brand.poolBlue} />
        </View>
        <Text style={styles.title}>Customization — coming soon</Text>
        <Text style={styles.body}>
          Custom paint, lights, and accessories are launching shortly. Message support to discuss a
          build right now.
        </Text>
