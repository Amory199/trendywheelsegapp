    ...
    <>
      ...
      <View style={styles.root}>
        <View style={styles.iconWrap}>
          <Ionicons name="cube" size={48} color={colors.brand.poolBlue} />
        </View>
        <Text style={styles.title}>Pickup & Delivery — coming soon</Text>
        <Text style={styles.body}>
          Door-to-door pickup and delivery is being rolled out. For now, message support to arrange
          transport.
        </Text>
