...
export default function LoginPage(): JSX.Element {
  ...
  async function submit(e: React.FormEvent): Promise<void> {
    ...
    try {
      ...
      const isStaff = result?.accountType === "admin" || result?.accountType === "staff";
      router.replace(isStaff ? "/crm" : "/");
    } catch (err) {
    ...
    <div style={styles.shell}>
      <div style={styles.hero}>
        ...
        <div className="tw-hero-ambient" aria-hidden>
          ...
          <div className="tw-hero-orb h-pool" />
          <div className="tw-hero-orb h-lime" />
        </div>
        <div
          className="tw-aura-ring"
          style={{ width: 480, height: 480, top: "-80px", left: "-120px" }}
        />
        <div
          className="tw-aura-ring"
          style={{
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.heroTitle}>
            Cruise bold.
            <br />
            Cruise trendy<span style={{ color: colors.brand.trendyPink }}>.</span>
          </h1>
          <p style={styles.heroSub}>
            Rent, sell, and service your golf cart — all in one place. Egypt&apos;s smartest resort
            mobility app.
          </p>
          <div style={styles.heroFooter}>
            <span style={styles.heroFooterDot} />
            <span>Customer · TrendyWheels</span>
          </div>
        </div>
      </div>
      ...
      <div style={styles.formPanel}>
        <div style={styles.formInner}>
          <div style={{ marginBottom: 28 }}>
            <span style={styles.eyebrow}>CUSTOMER PORTAL</span>
            <h2 style={styles.formTitle}>Sign in</h2>
            <p style={styles.formSub}>Welcome back. Your next ride awaits.</p>
          </div>
...
const styles: Record<string, React.CSSProperties> = {
  shell: { minHeight: "100vh", display: "flex", background: "#F7F7FB" },
  hero: {
    flex: "1 1 55%",
    minHeight: "100vh",
