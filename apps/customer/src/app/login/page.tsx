  ...
  return (
    <div style={styles.shell}>
      <div style={styles.hero}>
        ...
        <div className="tw-aura-ring" style={{ width: 480, height: 480, top: "-80px", left: "-120px" }} />
        <div className="tw-aura-ring" style={{ width: 720, height: 720, bottom: "-200px", right: "-220px", animationDirection: "reverse", animationDuration: "90s" }} />
